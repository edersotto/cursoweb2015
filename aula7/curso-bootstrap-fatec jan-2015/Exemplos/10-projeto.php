            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#" data-url="link_home.php" id="link_home">Home <span class="sr-only">(current)</span></a></li>
                        <li class="dropdown">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#" data-url="link_sobre.php">Sobre a Empresa</a></li>
                        <li><a href="#" data-url="link_fale.php">Fale Conosco</a></li>
                        ...
                        <li class="dropdown" id="menu_administrador">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="#">Gerenciar Catagorias</a></li>
